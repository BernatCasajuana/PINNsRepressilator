#!/bin/bash
#SBATCH --job-name=exp3_sampling_density       # Nom del job
#SBATCH --output=/home/10040984@uvic.local/projects/pinns-repressilator/jobs/exp3_sampling_density_output.txt
#SBATCH --error=/home/10040984@uvic.local/projects/pinns-repressilator/jobs/exp3_sampling_density_error.txt
...
print("=== Running exp3_sampling_density ===")
exp.main()
PY
