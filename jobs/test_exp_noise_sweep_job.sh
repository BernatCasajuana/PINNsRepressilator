...
python -u <<'PY'
from scripts.experiments import exp2_noise_sweep as exp

exp.train_iterations = 100

ROOT = "/home/10040984@uvic.local/projects/pinns-repressilator"

exp.results_dir = ROOT + "/results/test_exp2_noise_sweep"
exp.figure_path = ROOT + "/figures/test_exp2_noise_sweep.png"

print("=== Running quick test: exp2_noise_sweep ===")
