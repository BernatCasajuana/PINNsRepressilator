# Parameter estimation in the repressilator model using PINNs and DeepXDE (Parameters: n = 1.5 and beta = 10, corresponding to a stable system without oscillations)
