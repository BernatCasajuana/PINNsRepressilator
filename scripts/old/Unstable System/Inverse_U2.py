# Parameter estimation in the repressilator model using PINNs and DeepXDE (Parameters: n = 3 and beta = 5, corresponding to an unstable system with oscillations)
